...
ser = serial.Serial(port=your port,baudrate=9600,timeout=1) #change this according to your system, here I have used for my windows


#this function will create the box around the detected face
...
def write_image():
    ...
    cv2.imwrite("image.png"%(n),save_image)
...
face_casc = cv2.CascadeClassifier('haarcascade_frontalface_default.xml')# the face cascading feature for face identification
...
while videoWeb.isOpened():
    ...
    for (x,y,w,h) in faces:
        ...
        # recognize? deep learned model pr
